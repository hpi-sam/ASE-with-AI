...
def gridworld_10_cases_70_percent_returns(current_position: Tuple[int, int], actions: List[str]) -> Dict[str, Any]:
    ...
    # if-statement 2
    if current_position == (2, 2) and get_next_action(actions) == "west":
        # Action bumps into a wall
        return {"valid_action_sequence": False, "final_position": (2, 2)}
    ...
    # if-statement 5
    if current_position == (5, 1) and get_next_action(actions) == "west":
        # Action bumps into a wall
        return {"valid_action_sequence": False, "final_position": (5, 1)}

    # if-statement 6
    if current_position == (5, 3) and get_next_action(actions) == "east":
        # Action bumps into a wall
    ...
    # if-statement 8
    if current_position == (6, 4) and get_next_action(actions) == "east":
        current_position = move(current_position, "east")
