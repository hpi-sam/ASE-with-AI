...
def gridworld_10_cases_30_percent_returns(current_position: Tuple[int, int], actions: List[str]) -> Dict[str, Any]:
    ...
    # if-statement 1
    if current_position == (3, 6) and get_next_action(actions) == "south":
        current_position = move(current_position, "south")

    # if-statement 2
    if current_position == (4, 6) and get_next_action(actions) == "north":
    ...
    # if-statement 7
    if current_position == (6, 3) and get_next_action(actions) == "north":
        current_position = move(current_position, "north")
