...
def gridworld_15_cases_70_percent_returns(current_position: Tuple[int, int], actions: List[str]) -> Dict[str, Any]:
    ...
    # if-statement 3
    if current_position == (6, 6) and get_next_action(actions) == "east":
        # Action bumps into a wall
        return {"valid_action_sequence": False, "final_position": (6, 6)}
    ...
    # if-statement 7
    if current_position == (3, 5) and get_next_action(actions) == "west":
        # Action bumps into a wall
        return {"valid_action_sequence": False, "final_position": (3, 5)}

    # if-statement 8
    if current_position == (5, 1) and get_next_action(actions) == "east":
        # Action bumps into a wall
        return {"valid_action_sequence": False, "final_position": (5, 1)}
    ...
    # if-statement 10
    if current_position == (4, 5) and get_next_action(actions) == "north":
        current_position = move(current_position, "north")

    # if-statement 11
    if current_position == (3, 5) and get_next_action(actions) == "south":
    ...
    # if-statement 13
    if current_position == (3, 5) and get_next_action(actions) == "east":
        current_position = move(current_position, "east")

    # if-statement 14
    if current_position == (3, 6) and get_next_action(actions) == "west":
